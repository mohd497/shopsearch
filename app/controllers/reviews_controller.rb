class ReviewsController < ApplicationController
  ...
  http_basic_authenticate_with name: "secret", password: "secret", except: [:create, :reviews_per_house]
  ...
  private
    ...
    def review_params
      params.require(:review).permit(:title, :description, :rating, :sfthouse_id, :accepted)
    end
end
